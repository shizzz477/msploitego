...
def dotransform(args):
    ...
    if not fn:
        mt.addException(fn)
        mt.returnOutput()
    contents = getFileContents("/root/data/oscp_prep/repo/enum4/10.11.1.136-enum4.txt")
    regex = re.compile("^\|\s+")
...
# args = ['enum4linux.py',
#  'smb/139:517',
#  'properties.samba=smb/139:517#ip=10.11.1.5#service.name=smb/139:517#machinename=ALICE#banner.text=Microsoft Windows netbios-ssn#enum4linux=/root/data/oscp_prep/repo/enum4/10.11.1.5-enum4.txt#info=Microsoft Windows netbios-ssn#hostid=517#servicename=smb#proto=tcp#created_at=11/3/2018#updated_at=11/3/2018#workspaceid=18#state=open#serviceid=6823#workspace=default#port=139#user=msf#password=unDwIR39HP8LMSz3KKQMCNYrcvvtCK478l2qhIi7nsE\\=#db=msf']
# dotransform(args)